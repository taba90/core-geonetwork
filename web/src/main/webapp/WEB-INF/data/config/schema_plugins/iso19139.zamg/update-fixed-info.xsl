...
<xsl:stylesheet version="2.0"
    ...
    <xsl:template match="gmd:extent/gmd:EX_Extent/gmd:geographicElement/gmd:EX_GeographicBoundingBox">
        <xsl:variable name="regionCode" select="//gmd:extent/gmd:EX_Extent/gmd:geographicElement/gmd:EX_GeographicDescription/gmd:geographicIdentifier/gmd:RS_Identifier/gmd:code/gco:CharacterString"/>

        <xsl:choose>
            <xsl:when test="$regionCode='AT'">
               	<xsl:call-template name="createGeographicBoundingBox">
                    <xsl:with-param name="w" select="'60.50417'"/>
                    <xsl:with-param name="e" select="'74.91574'"/>
                    <xsl:with-param name="s" select="'29.40611'"/>
                    <xsl:with-param name="n" select="'38.47198'"/>
                </xsl:call-template>
            </xsl:when>
            <xsl:when test="$regionCode='AT-1'">
               	<xsl:call-template name="createGeographicBoundingBox">
            ...
            <xsl:when test="$regionCode='AT-2'">
               	<xsl:call-template name="createGeographicBoundingBox">
                    <xsl:with-param name="w" select="'2'"/>
                    <xsl:with-param name="e" select="'2'"/>
                    <xsl:with-param name="s" select="'2'"/>
                    <xsl:with-param name="n" select="'2'"/>
                </xsl:call-template>
            </xsl:when>
            <xsl:when test="$regionCode='AT-3'">
               	<xsl:call-template name="createGeographicBoundingBox">
                    <xsl:with-param name="w" select="'3'"/>
                    <xsl:with-param name="e" select="'3'"/>
                    <xsl:with-param name="s" select="'3'"/>
                    <xsl:with-param name="n" select="'3'"/>
                </xsl:call-template>
            </xsl:when>
            <xsl:when test="$regionCode='AT-4'">
               	<xsl:call-template name="createGeographicBoundingBox">
                    <xsl:with-param name="w" select="'4'"/>
                    <xsl:with-param name="e" select="'4'"/>
                    <xsl:with-param name="s" select="'4'"/>
                    <xsl:with-param name="n" select="'4'"/>
                </xsl:call-template>
            </xsl:when>
            <xsl:when test="$regionCode='AT-5'">
               	<xsl:call-template name="createGeographicBoundingBox">
                    <xsl:with-param name="w" select="'5'"/>
                    <xsl:with-param name="e" select="'5'"/>
                    <xsl:with-param name="s" select="'5'"/>
                    <xsl:with-param name="n" select="'5'"/>
                </xsl:call-template>
            </xsl:when>
            <xsl:when test="$regionCode='AT-6'">
               	<xsl:call-template name="createGeographicBoundingBox">
                    <xsl:with-param name="w" select="'6'"/>
                    <xsl:with-param name="e" select="'6'"/>
                    <xsl:with-param name="s" select="'6'"/>
                    <xsl:with-param name="n" select="'6'"/>
                </xsl:call-template>
            </xsl:when>
            <xsl:when test="$regionCode='AT-7'">
               	<xsl:call-template name="createGeographicBoundingBox">
                    <xsl:with-param name="w" select="'7'"/>
                    <xsl:with-param name="e" select="'7'"/>
                    <xsl:with-param name="s" select="'7'"/>
                    <xsl:with-param name="n" select="'7'"/>
                </xsl:call-template>
            </xsl:when>
            <xsl:when test="$regionCode='AT-8'">
               	<xsl:call-template name="createGeographicBoundingBox">
                    <xsl:with-param name="w" select="'8'"/>
                    <xsl:with-param name="e" select="'8'"/>
                    <xsl:with-param name="s" select="'8'"/>
                    <xsl:with-param name="n" select="'8'"/>
                </xsl:call-template>
            </xsl:when>
            <xsl:when test="$regionCode='AT-9'">
               	<xsl:call-template name="createGeographicBoundingBox">
                    <xsl:with-param name="w" select="'9'"/>
                    <xsl:with-param name="e" select="'9'"/>
                    <xsl:with-param name="s" select="'9'"/>
                    <xsl:with-param name="n" select="'9'"/>
                </xsl:call-template>
            </xsl:when>
            <xsl:otherwise>
                <xsl:message>==== Unknown region code  <xsl:value-of select="$regionCode"/> ====</xsl:message> 
                <xsl:copy>
                    <xsl:apply-templates select="@*|node()"/>
                </xsl:copy>
            </xsl:otherwise>
    ...
    <xsl:template name="createGeographicBoundingBox">
                    <xsl:param name="w"/>
                    <xsl:param name="e"/>
                    <xsl:param name="s"/>
                    <xsl:param name="n"/>
