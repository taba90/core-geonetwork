	...
	<xsl:template match="*" mode="metadata">
		...
		<xsl:for-each select="gmd:identificationInfo//gmd:MD_DataIdentification|
			...
			<xsl:for-each select="//gmd:MD_Keywords">
                ...
                <xsl:if test="starts-with(string(./gmd:thesaurusName/gmd:CI_Citation/gmd:identifier/gmd:MD_Identifier/gmd:code/gmx:Anchor), 'geonetwork.thesaurus.external.theme.zamg')">
